...
public class NpcAttack : MonoBehaviour
{
    ...
    public bool CanProjectile(Transform target, string layerToTarget, bool checkChance, bool ignoreCanAttack)
    {
        if (!canAttack && !ignoreCanAttack)
        {
            return false;
        ...
        */
        ...
        // Check line of sight
        RaycastHit hit;
        int checkMask = LayerMask.GetMask("Default", layerToTarget);
    ...
    public void DoMeleeAttack(string layerToTarget)
    {
    ...
    public void DoProjectileAttack(string layerToTarget)
    {
